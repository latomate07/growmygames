...
<div
  ...
  <form class="space-y-6" action="{{ url('user/create') }}" method="post" enctype="multipart/form-data">
    ...
    <div>
      <label for="text" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Votre Pseudo</label>
    ...
    <label for="role" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Type d'utilisateur :</label>
    <div class="flex justify-between" style="margin-top: 6px">
      <div class="flex items-center px-6 mr-2 rounded border border-gray-200 dark:border-gray-700">
        <input id="role-1" type="radio" value="Annonceur" name="role"
      ...
      <div class="flex items-center px-8 rounded border border-gray-200 dark:border-gray-700">
        <input checked id="role-2" type="radio" value="Webmaster" name="role"
          class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
        <label for="role-2"
          class="py-4 ml-2 w-full text-sm font-medium text-gray-900 dark:text-gray-300">
          Webmaster
    ...
    <div>
      <label for="avatar" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">
        Ajouter une photo de profil
      </label>
      <input type="file" name="avatar" id="avatar" placeholder="••••••••" accept="image/*"
        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
        required>
    </div>
    <button type="submit"
