...
<section class="text-gray-600 body-font relative">
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-col text-center w-full mb-12">
      ...
      <p class="lg:w-2/3 mx-auto leading-relaxed text-base">Besoin d'aide ? de renseignements ?</p>
    </div>
    <form class="lg:w-1/2 md:w-2/3 mx-auto" method="POST" action="" id="contact-form" onsubmit="event.preventDefault()">
      @csrf
      <div class="flex flex-wrap -m-2">
        ...
        <div class="p-2 w-full">
          <button type="submit" class="flex mx-auto text-white bg-blue-800 border-0 py-2 px-8 focus:outline-none hover:bg-blue-800 rounded text-lg">
            Envoyer
          </button>
        </div>
        <div class="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
          <a class="text-blue-800">growmygames@email.com</a>
          <p class="leading-normal my-5">15 rue Auguste Renoir
            <br>Chatou, 78400
          </p>
